{
  ...
  document
    .querySelector(".cultura_bold .content")
    .addEventListener("mousemove", (ev) => (mousePos = getMousePos(ev)));
  // update the touch position
  document
    .querySelector(".cultura_bold .content")
    .addEventListener("touchmove", (ev) => (mousePos = getTouchPos(ev)));
  ...
  document
    ...
    .addEventListener("touchstart", (ev) => {
      ...
      // Trigger mousemove event to start animation
  ...
  document
    ...
    .addEventListener("touchend", (ev) => {
      ...
      // Trigger mousemove event to end animation
      window.dispatchEvent(new MouseEvent("mousemove", ev));
    });
